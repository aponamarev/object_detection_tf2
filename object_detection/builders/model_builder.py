...
# TODO: Convert remaining architectures
...
def _build_ssd_model(ssd_config, is_training, add_summaries):
  ...
  if feature_extractor.is_keras_model:
    ...
    raise NotImplementedError("ssd_box_predictor only implemented in Keras")
  ...
  kwargs = {}
  if feature_extractor.is_keras_model:
      model = ssd_meta_arch.KerasSSDMetaArch(
              width=ssd_config.image_resizer.fixed_shape_resizer.width,
              height=ssd_config.image_resizer.fixed_shape_resizer.height,
      ...
      loss = ssd_meta_arch.KerasSSDLossLayer(
...
def _build_faster_rcnn_feature_extractor(
  ...
  raise NotImplementedError("Faster RCNN architecture yet to be converted")
